...
As leaders and moderators, we have the obligation to clearly define and uphold our acceptable standards. In response to any unacceptable behavior including inappropriate, threatening, offensive, or harmful, we will take action(s) that are appropriate, correct, and fair.

It is our right and responsibility to remove, edit, or reject any comments, commits, code, wiki edits, issues, and other contributions that don't adhere to this Code of Conduct. Explanations for moderation decisions will be provided as necessary.
...
Our Standards format was inspired by [GitHub Community Code of Conduct](
